...
[![Language: Python 3](https://img.shields.io/badge/Python-3.x-3776AB?style=for-the-badge&logo=python&logoColor=white)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=for-the-badge)](LICENSE)
[![Security Status](https://img.shields.io/badge/Security-100%25%20Clean-brightgreen?style=for-the-badge)](#)
...
```mermaid
flowchart TD
    A[Launch Application] --> B[Phase 1: Input Validation]
    B --> C{Phase 2: Operator Selection}
    C -- Standard --> D[Phase 3a: Perform +, -, *, /]
    C -- Modulo --> E[Phase 3b: Perform % Remainder]
    D --> F[Phase 4: Return Verified Result]
    E --> F
```
